  ...
  return (
    ...
    >
      ...
      <section className="max-w-2xl mb-10">
        ...
        <p className="text-gray-300 leading-8">
             • تجربه در معماری‌های استاندارد مثل Clean Architecture / MVVM / Bloc
        </p>
        <p className="text-gray-300 leading-8">
             • آشنایی با State Management (Bloc / Provider / Riverpod و …)
        </p>
        <p className="text-gray-300 leading-8">
             • آشنایی با Firebase (Auth, Firestore, Messaging)
        </p>
             • توانایی پیاده‌سازی UI دقیق و انیمیشن‌های نرم
        <p className="text-gray-300 leading-8">
             • توانایی پیاده‌سازی UI دقیق و انیمیشن‌های نرم
        </p>
        <p className="text-gray-300 leading-8">
             • تسلط بر Git و همکاری تیمی
        </p>
        </div>
      </section>
      ...
      <section className="max-w-2xl mb-10">
        ...
        <div className="px-5">
        <p className="text-gray-300 leading-8">
             • توسعه و نگهداری اپلیکیشن‌های Flutter (iOS و Android)
        </p>
        <p className="text-gray-300 leading-8">
             • پیاده‌سازی رابط کاربری دقیق مطابق طراحی
        </p>
        <p className="text-gray-300 leading-8">
             • ایجاد کامپوننت‌های قابل‌استفاده مجدد و ساختارمند
        </p>
        <p className="text-gray-300 leading-8">
             • بهینه‌سازی عملکرد و رفع باگ‌ها
        </p>
        <p className="text-gray-300 leading-8">
             • هماهنگی با طراح و توسعه‌دهنده بک‌اند برای تحویل روان پروژه
        </p>
        <p className="text-gray-300 leading-8">
             • تست و تحویل نسخه‌های Stable
        </p>
        </div>
      </section>
      ...
      <section className="max-w-2xl mb-10">
        ...
        <div className="px-5">
        <p className="text-gray-300 leading-8">
             • تجربه با Native Android/iOS
        </p>
        <p className="text-gray-300 leading-8">
             • آشنایی با CI/CD
        </p>
        <p className="text-gray-300 leading-8">
             • تجربه در Push Notification & Background Services
        </p>
        <p className="text-gray-300 leading-8">
             • آشنایی با اصول UX و طراحی قابل استفاده
        </p>
        </div>
      </section>
      ...
      <section className="max-w-2xl mb-10">
        ...
        <div className="px-5">
        <p className="text-gray-300 leading-8">
            به صورت پروژه ای (  شروع از ۴۰  میلیون تومان برنامه‌ریزی به ازای هر پروژه بر اساس سطح مهارت و زمان تحویل)
        </p>
        </div>
      </section>
      </div>
